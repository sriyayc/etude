...
app.add_page(
    subjects_page,
    route="/resources/[semester]",
    on_load=[UserState.load_profile, ResourceState.load_subjects],
)
app.add_page(
    subject_detail_page,
    route="/resources/[semester]/[subject_code]",
    on_load=[UserState.load_profile, ResourceState.load_subject],
)
app.add_page(
    slides_viewer_page,
    route="/resources/[semester]/[subject_code]/slides",
    on_load=[UserState.load_profile, ResourceState.load_slides],
)
app.add_page(
    quiz_page,
    route="/resources/[semester]/[subject_code]/quiz",
    on_load=[UserState.load_profile, ResourceState.load_subject],
)
app.add_page(
    flashcards_page,
    route="/resources/[semester]/[subject_code]/flashcards",
    on_load=[UserState.load_profile, ResourceState.load_subject],
)
app.add_page(
    notes_page,
    route="/resources/[semester]/[subject_code]/notes",
    on_load=[UserState.load_profile, ResourceState.load_subject],
)
