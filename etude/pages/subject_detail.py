...
def source_column(icon: str, label: str, title: str, description: str, count_label: str, href: str):
    return rx.vstack(
        ...
        rx.hstack(
            ...
            rx.link(
                rx.hstack(
                    rx.text("OPEN", font_family="monospace", font_size="12px"),
...
def subject_detail_page():
    ...
    return rx.box(
        topbar(
            breadcrumb=subject_code,
            active="resources",
            srn=UserState.srn,
            back_href=f"/resources/{semester}",
        ),
        rx.box(
            rx.vstack(
                ...
                rx.hstack(
                    ...
                    rx.text(
                        ResourceState.current_subject["slide_count"],
                        " slides",
                        color=ACCENT_LIGHT,
                        font_family="monospace",
                        font_size="13px",
            ...
            rx.hstack(
                source_column(
                    ...
                    ResourceState.current_subject["slide_count"].to_string() + " SLIDES",
                ...
                source_column(
                    ...
                    ResourceState.current_subject["page_count"].to_string() + " PAGES",
            ...
            rx.hstack(
                ...
                rx.hstack(
                    rx.link(
                        "→ FLASHCARDS",
                        href=f"/resources/{semester}/{subject_code}/flashcards",
                        color=ACCENT,
                        font_family="monospace",
                        font_size="12px",
                    ),
